SetupLawyers = function(data) {
    ...
    if (data.length > 0) {
        ...
        $(".lawyers-list").append('<h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; border-top-left-radius: .5vh; border-top-right-radius: .5vh; width:100%; display:block; background-color: rgb(42, 137, 214);">Advocacia (' + lawyers.length + ')</h1>');
        ...
        if (lawyers.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">Não há advogados disponíveis.</div></div>'
            $(".lawyers-list").append(element);
        }

        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(155, 15, 120);">Imobiliária (' + realestate.length + ')</h1>');
        ...
        if (realestate.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">Não há corretores de imóveis disponíveis.</div></div>'
            $(".lawyers-list").append(element);
        }

        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(0, 204, 102);">Mecânica (' + mechanic.length + ')</h1>');
        ...
        if (mechanic.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">Não há mecânicos disponíveis.</div></div>'
            $(".lawyers-list").append(element);
        }

        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(255, 190, 27);">Táxi (' + taxi.length + ')</h1>');
        ...
        if (taxi.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">Não há táxistas disponíveis.</div></div>'
            $(".lawyers-list").append(element);
        }
        
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(0, 102, 255);">Polícia (' + police.length + ')</h1>');
        ...
        if (police.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">Não há políciais disponíveis.</div></div>'
            $(".lawyers-list").append(element);
        }
        
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(255, 0, 0);">Hospital (' + ambulance.length + ')</h1>');
        ...
        if (ambulance.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">Não há médicos disponíveis.</div></div>'
            $(".lawyers-list").append(element);
        }
    } else {
        $(".lawyers-list").append('<h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; border-top-left-radius: .5vh; border-top-right-radius: .5vh; width:100%; display:block; background-color: rgb(42, 137, 214);">Advocacia (' + lawyers.length + ')</h1>');
                ...
                if (status.CanCall) {
                    if (!status.InCall) {
                        if (QB.Phone.Data.AnonymousCall) {
                            QB.Phone.Notifications.Add("fas fa-phone", "Telefone", "Você iniciou uma chamada anônima!");
                        }
                        ...
                        QB.Phone.Notifications.Add("fas fa-phone", "Telefone", "Você já está conectado a uma chamada!");
                    }
                } else {
                    QB.Phone.Notifications.Add("fas fa-phone", "Telefone", "Esta pessoa já está em uma chamada");
                }
            } else {
                QB.Phone.Notifications.Add("fas fa-phone", "Telefone", "Esta pessoa não está disponível!");
            }
        } else {
            QB.Phone.Notifications.Add("fas fa-phone", "Telefone", "Você não pode ligar para seu próprio número!");
        }
    });
});
